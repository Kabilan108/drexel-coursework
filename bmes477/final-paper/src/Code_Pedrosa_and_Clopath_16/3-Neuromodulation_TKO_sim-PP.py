...
R = 2. 				# [Ohm] Resistance of the leaky I-F model for excitatory neurons
...
# set equal for PP STDP rule
a_plus = a_minus = float(args[1])	# Coefficient related to post->pre activity

# Simulation parameters ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
dt = 1. 			# [ms] Simulation time step
numSteps = int(t_max/dt)	# Number of steps in simulation
