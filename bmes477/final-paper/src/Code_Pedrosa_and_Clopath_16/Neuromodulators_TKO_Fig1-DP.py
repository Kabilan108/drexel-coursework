...
args = [[0.0003, 0.0003], [0.01, 1.], [0.02, 10.]] 
...
for arg in args:
	subprocess.call('python 3-Neuromodulation_TKO_sim-DP.py {0} {1}'.format(arg[0],arg[1]),shell=True)
...
subprocess.call('python Make_figs2_TKO.py Fig1-DP.png',shell=True)
