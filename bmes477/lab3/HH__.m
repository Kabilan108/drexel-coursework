...
% Pull all the pertinent variables from the main workspace using evalin
% mainly so in the homework we don't have to change values twice
Cm = evalin('base','Cm');
I = evalin('base','Iin');
ENa = evalin('base','ENa');
EK = evalin('base','EK');
El = evalin('base','El');
gbarNa = evalin('base','gbarNa');
gbarK = evalin('base','gbarK');
gbarl = evalin('base','gbarl');
