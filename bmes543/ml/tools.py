...
def hwmaml_breastcancer_trainandtest(X_train, y_train, X_test, y_test):
    """
    Train an SVM on provided training data, and test it on the provided
    testing data. Return the model accuracry
    """
