function [X,T,names] = loadcatsite()
% [[Write your name here]] 
% template by: AhmetSacan.
% load catsite data into a numerical matrix X. Each row of X should
% represent a sample. Each column of X should represent an attribute. Each
% row of T should represent the target value of a sample. The names output
